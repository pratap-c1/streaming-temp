...
import screen.record.and.serve.databinding.ActivityRtspClientBinding;

public class RTSPClientActivity extends AppCompatActivity
    implements View.OnClickListener, RtspClient.Callback, Session.Callback, SurfaceHolder.Callback,
    RadioGroup.OnCheckedChangeListener {
  public final static String TAG = RTSPClientActivity.class.getCanonicalName();
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    ActivityRtspClientBinding binding =
        DataBindingUtil.setContentView(this, R.layout.activity_rtsp_client);
  ...
  @Override public void onSessionError(int reason, int streamType, Exception e) {
    mProgressBar.setVisibility(View.GONE);
    switch (reason) {
  ...
  @Override public void onRtspUpdate(int message, Exception e) {
    switch (message) {
